...
public abstract class DL4JAiOnnxOperatorSet extends AiOnnxOperatorSet {

	public DL4JAiOnnxOperatorSet(int irVersion, String irVersionPrerelease, String irBuildMetadata, long opsetVersion,
			String docString) {
